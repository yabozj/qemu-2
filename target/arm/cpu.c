...
static void arm_cpu_reset(CPUState *s)
{
    ...
    if (arm_feature(env, ARM_FEATURE_M)) {
        ...
        if (!rom) {
            /* HACK: Give a chance to load from 0x08000000 if the ROM was not
             *       found.
             */
            rom = rom_ptr(0x08000000, 8);
        }
...
static void cortex_m4f_initfn(Object *obj)
{
    ...
    set_feature(&cpu->env, ARM_FEATURE_VFP4_SP);
...
static Property arm_cpu_properties[] = {
    ...
    DEFINE_PROP_UINT32("gtimer-scale", ARMCPU, gtimer_scale, GTIMER_SCALE),

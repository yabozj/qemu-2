...
#define SPR_E500MC_DBSRWR     (0x132)
...
#define SPR_GSPRG0            (0x170)
#define SPR_GSPRG1            (0x171)
#define SPR_GSPRG2            (0x172)
#define SPR_GSPRG3            (0x173)
#define SPR_BOOKE_MAS7_MAS3   (0x174)
#define SPR_BOOKE_GSRR0       (0x17A)
#define SPR_BOOKE_GSRR1       (0x17B)
#define SPR_BOOKE_GEPR        (0x17C)
#define SPR_BOOKE_GDEAR       (0x17D)
#define SPR_BOOKE_GPIR        (0x17E)
#define SPR_BOOKE_GESR        (0x17F)
